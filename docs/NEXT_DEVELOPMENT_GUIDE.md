...
已建立共用樣式庫於 `src/styles/`：

| 檔案 | 用途 |
|------|------|
| `_variables.less` | 設計系統變數（顏色、間距、字型、陰影等） |
| `_page-header.less` | 頁面標頭樣式 |
| `_stat-cards.less` | 統計卡片樣式 |
| `_nav-cards.less` | 導航卡片樣式 |
| `_filter-card.less` | 篩選器卡片樣式 |
| `_drawer.less` | 抽屜表單樣式 |
| `_empty-state.less` | 空狀態樣式 |
| `_actions.less` | 操作按鈕樣式 |

### 活動時間軸整合 ✅ 已完成

- ✅ 建立 `ActivityTimelineComponent` 元件
- ✅ 整合至藍圖概覽頁面「活動」Tab
- ✅ 支援篩選（動作類型、實體類型）
- ✅ 支援分頁載入更多
- ✅ 顯示相對時間（剛剛、幾分鐘前等）
...
| **活動 Tab** | ✅ 100% | 活動時間軸 + 篩選器 + 統一標頭（重新整理按鈕）✨ 新完成 |
...
1. ~~**活動時間軸 (Activity)** - 操作記錄、變更歷史（需 AuditLog）~~ ✅ 已完成
...
│   │   └─ 通知分類系統                        ████████████ 完成 │
│   ✅ 操作審計日誌 (Audit Log) ✨ 已完成        ████████████ 完成 │
│   │   ├─ AuditLogRepository                  ████████████ 完成 │
│   │   ├─ AuditLogService                     ████████████ 完成 │
│   │   ├─ 審計日誌類型定義                    ████████████ 完成 │
│   │   └─ ActivityTimelineComponent ✨ 新完成 ████████████ 完成 │
│   ✅ UI 統一樣式庫 (Style Library) ✨ 新完成   ████████████ 完成 │
│   │   ├─ _variables.less                     ████████████ 完成 │
│   │   ├─ _page-header.less                   ████████████ 完成 │
│   │   ├─ _stat-cards.less                    ████████████ 完成 │
│   │   ├─ _nav-cards.less                     ████████████ 完成 │
│   │   └─ 其他樣式檔案                        ████████████ 完成 │
