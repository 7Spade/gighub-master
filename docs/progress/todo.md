...
| 編號 | 待辦項目 | 優先級 | 預計工時 | 狀態 |
| ---- | -------- | ------ | -------- | ---- |
| TD-CLN-001 | 清理所有 Mock 資料和後備機制 | P0 | 6h | ✅ 完成 |
| TD-CLN-002 | 移除 Deprecated 方法 | P1 | 4h | ✅ 完成 |
| TD-CLN-003 | 替換 any 類型為具體型別 | P2 | 8h | ⏳ 待處理 |
| TD-CLN-004 | 清理 console.log 語句 | P2 | 4h | 🟡 部分完成 |
| TD-CLN-005 | 拆分大型組件 (>500行) | P2 | 24h | ⏳ 待處理 |
| TD-CLN-006 | 解耦複雜服務依賴 | P3 | 8h | ⏳ 待處理 |
| TD-CLN-007 | 統一錯誤處理模式 | P3 | 6h | ⏳ 待處理 |
| TD-CLN-008 | 統一日期格式使用 | P3 | 2h | ✅ 完成 |
| TD-CLN-009 | 移除 Placeholder 程式碼 | P2 | 4h | ✅ 完成 |
| TD-CLN-010 | 建立統一 Logger 服務 | P2 | 4h | ⏳ 待處理 |
