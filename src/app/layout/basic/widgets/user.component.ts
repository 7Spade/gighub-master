 ...
 * Header user component
 *
 * Displays current user info based on workspace context.
 * Integrated with WorkspaceContextService and SupabaseAuthService.
 *
...
export class HeaderUserComponent {
  ...
  async logout(): Promise<void> {
    await this.supabaseAuth.signOut().toPromise();
