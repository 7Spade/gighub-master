      ...
      @if (authContext.switching()) {
        ...
        @switch (authContext.contextType()) {
          ...
          @case (ContextType.TEAM) {
            <nz-alert nzType="info" nzMessage="團隊設定" nzDescription="團隊設定功能正在開發中" nzShowIcon></nz-alert>
          }
          @case (ContextType.BOT) {
            <nz-alert nzType="info" nzMessage="機器人設定" nzDescription="機器人設定功能正在開發中" nzShowIcon></nz-alert>
          }
        }
      }
    </nz-card>
...
export class SettingsComponent extends BaseContextAwareComponent {
  protected readonly contextConfigs = {
    [ContextType.USER]: {
      title: '個人設定',
      subtitle: '管理 {label} 的個人帳號設定',
      cardTitle: '帳號設定'
    },
    [ContextType.ORGANIZATION]: {
      title: '組織設定',
      subtitle: '管理 {label} 的組織設定',
      cardTitle: '組織設定'
    },
    [ContextType.TEAM]: {
      title: '團隊設定',
      subtitle: '管理 {label} 的團隊設定',
      cardTitle: '團隊設定'
    },
    [ContextType.BOT]: {
      title: '機器人設定',
      subtitle: '管理 {label} 的機器人設定',
      cardTitle: '機器人設定'
    }
  };
