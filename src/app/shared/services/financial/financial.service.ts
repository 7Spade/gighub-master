...
export class FinancialService {
  ...
  async loadBlueprintFinancialSummary(blueprintId: string): Promise<BlueprintFinancialSummary | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to load blueprint financial summary', err);
  ...
  async getBlueprintFinancialSummary(blueprintId: string): Promise<BlueprintFinancialSummary | null> {
    try {
      ...
      this.logger.error('FinancialService - Failed to get blueprint financial summary', err);
      return null;
    }
  }
  ...
  async loadContractsForBlueprint(blueprintId: string): Promise<Contract[]> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to load contracts for blueprint', err);
      this.error.set(message);
      return [];
    } finally {
      this.loading.set(false);
  ...
  async findContractById(id: string): Promise<Contract | null> {
    try {
      ...
      this.logger.error('FinancialService - Failed to find contract by ID', err);
      return null;
    }
  }
  ...
  async findContractsWithOptions(options: ContractQueryOptions): Promise<Contract[]> {
    try {
      ...
      this.logger.error('FinancialService - Failed to find contracts with options', err);
      return [];
    }
  }
  ...
  async getContractSummary(contractId: string): Promise<ContractSummary | null> {
    try {
      ...
      this.logger.error('FinancialService - Failed to get contract summary', err);
      return null;
    }
  }
  ...
  async loadExpensesForBlueprint(blueprintId: string): Promise<Expense[]> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to load expenses for blueprint', err);
      this.error.set(message);
      return [];
    } finally {
      this.loading.set(false);
  ...
  async findExpensesWithOptions(options: ExpenseQueryOptions): Promise<Expense[]> {
    try {
      ...
      this.logger.error('FinancialService - Failed to find expenses with options', err);
      return [];
    }
  }
  ...
  async loadPaymentRequestsForBlueprint(blueprintId: string): Promise<PaymentRequest[]> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to load payment requests for blueprint', err);
      this.error.set(message);
      return [];
    } finally {
      this.loading.set(false);
  ...
  async findPaymentRequestsWithOptions(options: PaymentRequestQueryOptions): Promise<PaymentRequest[]> {
    try {
      ...
      this.logger.error('FinancialService - Failed to find payment requests with options', err);
      return [];
    }
  }
  ...
  async loadPaymentsForBlueprint(blueprintId: string): Promise<Payment[]> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to load payments for blueprint', err);
      this.error.set(message);
      return [];
    } finally {
      this.loading.set(false);
  ...
  async findPaymentsWithOptions(options: PaymentQueryOptions): Promise<Payment[]> {
    try {
      ...
      this.logger.error('FinancialService - Failed to find payments with options', err);
      return [];
    }
  }
  ...
  async loadAllFinancialData(blueprintId: string): Promise<void> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to load all financial data', err);
      this.error.set(message);
    } finally {
      this.loading.set(false);
    }
  ...
  async createContract(data: Partial<Contract>): Promise<Contract | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to create contract', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async updateContract(id: string, data: Partial<Contract>): Promise<Contract | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to update contract', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async deleteContract(id: string): Promise<boolean> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to delete contract', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async createExpense(data: Partial<Expense>): Promise<Expense | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to create expense', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async updateExpense(id: string, data: Partial<Expense>): Promise<Expense | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to update expense', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async deleteExpense(id: string): Promise<boolean> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to delete expense', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async createPaymentRequest(data: Partial<PaymentRequest>): Promise<PaymentRequest | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to create payment request', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async updatePaymentRequest(id: string, data: Partial<PaymentRequest>): Promise<PaymentRequest | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to update payment request', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async deletePaymentRequest(id: string): Promise<boolean> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to delete payment request', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async createPayment(data: Partial<Payment>): Promise<Payment | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to create payment', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async updatePayment(id: string, data: Partial<Payment>): Promise<Payment | null> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to update payment', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
  ...
  async deletePayment(id: string): Promise<boolean> {
    ...
    try {
      ...
      this.logger.error('FinancialService - Failed to delete payment', err);
      this.error.set(message);
      throw err;
    } finally {
      this.loading.set(false);
