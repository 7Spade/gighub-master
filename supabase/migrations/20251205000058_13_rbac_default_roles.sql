-- ============================================================================
-- Migration: 13 - RBAC Default Roles
-- Description: RBAC 預設角色 API (建立預設角色)
-- Category: 13 - RBAC Configuration
-- 
-- 當藍圖建立時，自動建立預設角色
-- ============================================================================
...
DROP TRIGGER IF EXISTS on_blueprint_created_roles ON public.blueprints;
...
-- Documentation
COMMENT ON FUNCTION public.create_default_blueprint_roles(UUID) 
  IS '建立預設藍圖角色 - Create default roles for blueprint';
COMMENT ON FUNCTION public.handle_new_blueprint_roles() 
  IS '藍圖觸發器 - 自動建立預設角色';
